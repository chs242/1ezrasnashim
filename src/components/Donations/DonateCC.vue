<template>
  <div class="md:w-full mx-auto">
      ...
      <span class="relative z-0 inline-flex shadow-sm">
        <button
          ...
          :class="{
            ...
            'shadow-outline-brand z-20' : selectedMethod === i
          }"
    ...
    <div class="text-center">
      <base-button :cta="complete" @click="pay" :disabled="!complete" class="my-8">Donate Now</base-button>
    </div>
  </div>
</template>
...
export default {
  name: "DonateCC",
  props: ["formData", "plan", "selectedMethod"],
