<template>
  <div class="md:w-full mx-auto">
    ...
    <div v-show="state === STATES.IDLE" class="payment-method">
      ...
      <!-- CHEQUE -->
      <div v-if="selectedMethod == 2" class="method cheque mb-8">
        <p
          class="text-sm"
        ...
        <p
          class="pl-6 text-gray-700 text-sm"
        >All contributions will be gratefully acknowledged and are tax deductible.</p>
      </div>
    </div>
