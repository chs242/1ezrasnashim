    ...
    <Layout>
       <div id="banner-section" class="w-full mt-12 lg:mt-0">
           <div class="relative w-full">
            <h1 class="banner-h1 text-white text-5xl lg:text-6xl font-source font-bold absolute leading-none px-12 md:px-32 lg:px-56">Bridging the gap for woman in emergency care.</h1>
